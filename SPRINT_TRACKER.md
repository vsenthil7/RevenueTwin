...
| S85 | SPEC GAP: THREAT_MODEL.md (STRIDE) | Shared standard E.5 requires THREAT_MODEL.md (STRIDE) with mitigations mapped to specific tests, incl prompt-injection-in-contract adversarial case. Currently only scattered notes. | planned (spec gap) | TBD |
