...
| S84 | SPEC GAP: SEED_MANIFEST.md + precision/recall | Shared standard A.5/E.6 require a SEED_MANIFEST.md enumerating every planted defect with ground-truth labels, and published precision/recall/F1 vs that manifest with a regression gate. Currently absent. | planned (spec gap) | TBD |
