...
| S86 | SPEC GAP: mutation testing gate (Stryker >=90%) | Shared standard C.2 requires a named mutation tool (Stryker for TS) with a >=90% gate on core modules. Not wired; tracker references it but no devDependency/script. | planned (spec gap) | TBD |
