...
| S83 | SPEC GAP: ContractIntentMismatch entity | V03 calls this the most original reasoning artifact and it is only named in docs, not built. Add ContractIntentMismatch entity + confidence model + human-resolution workflow + audit; present BOTH contract and intent, never auto-pick. | planned (spec gap) | TBD |
