...
| S56 | Unit test pyramid pt.2 | Done: consolidation, allocation, anomaly, dataquality, forecast, churn, policy, tenancy, disputes, metrics, usage, amendments. Remaining: benchmarking, evidence, scheduler, webhooks, tax, contracts, revrec, detectors, partners, journal, segments, alerts, workflow. | 🔄 in progress | 117 so far |
