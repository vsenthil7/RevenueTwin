...
| S56 | Unit test pyramid pt.2 | The ~30 revenue-domain modules to 100%. Done: consolidation, allocation, anomaly, dataquality. Remaining: forecast, disputes, policy, metrics, tenancy, usage, amendments, benchmarking, evidence, scheduler, webhooks, tax, contracts, revrec, churn, detectors, partners, journal, segments, alerts, workflow. | 🔄 in progress | 40 so far |
