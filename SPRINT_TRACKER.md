...
| S56 | Unit test pyramid pt.2 | Done: consolidation, allocation, anomaly, dataquality, forecast, churn, policy, tenancy. Remaining: disputes, metrics, usage, amendments, benchmarking, evidence, scheduler, webhooks, tax, contracts, revrec, detectors, partners, journal, segments, alerts, workflow. | 🔄 in progress | 74 so far |
